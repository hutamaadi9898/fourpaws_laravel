...
<body class="font-sans antialiased h-full">
    <div
        ...
        {{-- Header/Navigation --}}
        <header
            class="sticky top-0 z-50 backdrop-blur-sm bg-white/80 border-b border-slate-200">
        ...
        <main>
                ...
                <section class="relative py-20 lg:py-32">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="text-center">
                            ...
                            <p
                                class="text-xl text-slate-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <button wire:click="switchTab('templates')"
                                    class="border border-slate-300 text-slate-700 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-slate-50 transition-all duration-200">
                                    View Templates
                                </button>
                            </div>
                        </div>
                ...
                <section class="py-16 bg-white/50 backdrop-blur-sm">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="grid grid-cols-3 gap-8 text-center">
                            <div>
                                <div class="text-3xl md:text-4xl font-bold text-slate-900">{{
                                    number_format($stats['memorials']) }}+</div>
                                <div class="text-slate-600 mt-2">Memorials Created</div>
                            </div>
                            <div>
                                <div class="text-3xl md:text-4xl font-bold text-slate-900">{{
                                    $stats['templates'] }}</div>
                                <div class="text-slate-600 mt-2">Beautiful Templates</div>
                            </div>
                            <div>
                                <div class="text-3xl md:text-4xl font-bold text-slate-900">{{
                                    number_format($stats['users']) }}+</div>
                                <div class="text-slate-600 mt-2">Loving Families</div>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div
                                ...
                                <h3 class="text-xl font-semibold text-slate-900 mb-2">Photo
                                    Galleries</h3>
                                <p class="text-slate-600">Upload and organize your favorite photos
                            ...
                            <div
                                ...
                                <h3 class="text-xl font-semibold text-slate-900 mb-2">Share Stories
                                </h3>
                                <p class="text-slate-600">Write and share heartwarming stories and
                            ...
                            <div
                                ...
                                <h3 class="text-xl font-semibold text-slate-900 mb-2">Guest Messages
                                </h3>
                                <p class="text-slate-600">Allow friends and family to leave
                            ...
                            <div
                                ...
                                <h3 class="text-xl font-semibold text-slate-900 mb-2">Beautiful
                                    Templates</h3>
                                <p class="text-slate-600">Choose from professionally designed
                            ...
                            <div
                                ...
                                <h3 class="text-xl font-semibold text-slate-900 mb-2">Easy Sharing
                                </h3>
                                <p class="text-slate-600">Share your pet's memorial page with family
                            ...
                            <div
                                ...
                                <h3 class="text-xl font-semibold text-slate-900 mb-2">Private &
                                    Secure</h3>
                                <p class="text-slate-600">Your memorial pages are secure and private
                ...
                <section class="py-20 bg-slate-50">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div
                                class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden group hover:shadow-md transition-shadow duration-200">
                                ...
                                <div class="p-6">
                                    <h3 class="text-lg font-semibold text-slate-900 mb-2">{{
                                        $template->name }}</h3>
                                    <p class="text-slate-600 text-sm mb-4">{{ $template->description
                                        }}</p>
            ...
            <div>
                ...
                <div
                    class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden group hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                    <div class="aspect-video bg-gradient-to-br {{ 
                                    match($template->template_data['theme_color'] ?? '#1e40af') {
                                        '#1e40af' => 'from-blue-400 to-blue-600',
                                        '#059669' => 'from-green-400 to-green-600',
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('memorial.show', $memorial) }}"
                                class="text-blue-600 text-sm font-medium hover:text-blue-700 flex items-center space-x-1 group">
